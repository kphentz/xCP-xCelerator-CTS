...
public class CreateNewPDFObject extends DfSingleDocbaseModule
{
    public Result execute (String packageToTransform, boolean newObject, String newObjectName, String newObjectType, String rootPathName, String appendPath, String folderObjectType){
        ...
        try{
        	DfLogger.debug(this,"Inside Create New PDF Rendition Object", null, null);
		    session = getSession();
			...
			DfLogger.debug(this,"Finding profiles to transform document to PDF",  null, null);
        	...
        	DfLogger.debug(this, "PDF Rendition created Successfully"  , null, null);
    	    return result;
        }catch (DfException e){
        	String errorMsg = "DFC Error creating PDF Rendition";
            DfLogger.error(this, errorMsg, null, e);
            result.setErrorMessage(errorMsg);
            result.setSuccess(false);
        }catch(Exception e){
        	String errorMsg = "Error creating PDF Rendition";
